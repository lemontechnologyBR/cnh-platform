...
const FIELDS = [
  ...
  { key: 'sexo',          label: 'Sexo',                      placeholder: 'MASCULINO', mask: 'upper' },
  { key: 'acc',           label: 'ACC',                       placeholder: 'NAO', mask: 'upper', default: 'NAO' },
  { key: 'observacoes',   label: 'Observações',               placeholder: 'A', mask: 'upper' },
  { key: 'uf',            label: 'UF emissão',                placeholder: 'SP', mask: 'upper' },
  { key: 'codigoValidacao', label: 'Código validação CNH',    placeholder: '6345668990', mask: 'digits10', inputMode: 'numeric' },
  { key: 'renach',        label: 'Nº Formulário RENACH',      placeholder: 'SP01630571', mask: 'upper' },
  { key: 'seloBomCondutor', label: 'Selo bom condutor',       placeholder: 'NAO', mask: 'upper', default: 'NAO' },
